...
},{"./models/equipment/EquipmentSkills":"../../data-provider/models/equipment/EquipmentSkills.ts"}],"../../data-provider/models/equipment/EquipmentCategory.ts":[function(require,module,exports) {
"use strict";
...
},{}],"../../data-provider/models/user/UserEquipmentSettings.ts":[function(require,module,exports) {
"use strict";
...
},{"../equipment/EquipmentCategory":"../../data-provider/models/equipment/EquipmentCategory.ts"}],"../../helper/html.helper.ts":[function(require,module,exports) {
"use strict";
...
},{}],"../ui/eq-settings.component.ts":[function(require,module,exports) {
"use strict";
...
var STORAGE_KEY = 'dos-eq-settings';
var saveToStorage = function saveToStorage() {
  window.localStorage.setItem(STORAGE_KEY, UserEquipmentSettings_1.default.Instance.serialize());
};
...
var getSetElement = function getSetElement(set, skillData, searchParams) {
  ...
  var row1 = html_helper_1.htmlToElement("\n    <tr class=\"result-set-row result-set-row1\">\n      <td style=\"width: 20%\">".concat(set.head.name, "</td>\n      <td style=\"width: 20%\">").concat(set.chest.name, "</td>\n      <td style=\"width: 20%\">").concat(set.arms.name, "</td>\n      <td style=\"width: 20%\">").concat(set.waist.name, "</td>\n      <td style=\"width: 20%\">").concat(set.legs.name, "</td>\n    </tr>"));
...
exports.renderResults = function (sets, skillData, searchParams, pinsOrExclActive) {
  ...
  var header = html_helper_1.htmlToElement('<tr><th>Head</th><th>Torso</th><th>Arms</th><th>Waist</th><th>Legs</th></tr>');
...
var searchLogic = function searchLogic(equData, skillData) {
  ...
  // search for sets
  var result = searcher_module_1.search(equData.armor, equData.decorations, [], searchParams, skillData);
  // render results
...
var moreSkillsLogic = function moreSkillsLogic(equData, skillData) {
  return __awaiter(_this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var searchParams, aquirableSkills, outputIterator, _iterator, _step, actMap, sActs, processedActs, breakFlag, _iterator2, _step2, _loop, _ret;
                  ...
                  switch (_context.prev = _context.next) {
                    ...
                    case 4:
                      ...
                      return new Promise(function (resolve, _reject) {
                        setTimeout(function () {
                          var innerR = searcher_module_1.search(equData.armor, equData.decorations, [], newParams, skillData);
                          resolve(innerR);
                        });
                      });
                    case 7:
    ...
    }, _callee, null, [[7, 37, 40, 43], [15, 27, 30, 33]]);
  }));
};
...
},{"../../searcher/searcher.module":"../../searcher/searcher.module.ts","./global-settings.component":"../ui/global-settings.component.ts","./picker.component":"../ui/picker.component.ts","./search-results.component":"../ui/search-results.component.ts","../../data-provider/models/user/UserEquipmentSettings":"../../data-provider/models/user/UserEquipmentSettings.ts"}],"index.ts":[function(require,module,exports) {
"use strict";
...
main();
},{"../../data-provider/data-provider.module":"../../data-provider/data-provider.module.ts","../ui/eq-settings.component":"../ui/eq-settings.component.ts","../ui/navbar.component":"../ui/navbar.component.ts","../ui/picker.component":"../ui/picker.component.ts","../ui/search-controls.component":"../ui/search-controls.component.ts"}],"../../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
